/**
 * Khan Moves — Backend Price Calculator
 * Must remain identical to frontend priceCalculator.js
 */
        ...
        if (!isBoxesService) {
            ...
            if (dismantleCharge > 0) {
                ...
                breakdown.push({
                    ...
                    amount: roundMoney(dismantleCharge)
                });
            ...
            if (assemblyCharge > 0) {
                ...
                breakdown.push({
                    ...
                    amount: roundMoney(assemblyCharge)
                });
            ...
            if (packingCharge > 0) {
                ...
                breakdown.push({
                    ...
                    amount: roundMoney(packingCharge)
                });
